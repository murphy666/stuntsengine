...
struct CARSTATE {
    ...
    short car_gearknob_cur_x;
    short car_body_slip_angle;
    short car_gearknob_cur_y;
    short car_gearknob_target_x;
    short car_gearknob_target_y;
    short car_angle_z;
    short car_front_wheel_angle;
    ...
    short car_wheel_susp_ext[4];
    short car_wheel_susp_compress[4];
    short car_rc3[4];
    short car_wheel_susp_damp[4];
    short car_wheel_susp_target[4];
...
struct GAMESTATE {
    int32_t game_debris_dx[24];
    int32_t game_debris_dy[24];
    int32_t game_debris_dz[24];
    struct VECTOR game_camera_pos[2];
    struct VECTOR game_camera2_pos[2];
    ...
    short game_debris_vy[24];
    char kevinseed[6];
    bool game_checkpoint_valid;
    char game_inputmode;
    char game_crash_eval_type;
...
struct TRACKOBJECT {
    ...
    char
        ss_multiTileFlag; // 0 = one-tile, 1 = two-tile vertical, 2 = two-tile horizontal, 3 = four-tile.
